...
scary1 = Film.create!(list: 'true', genre: 'scary, indie', title: "Boolala", year: 2019, rating: "PG", description: "Zak has an invisible friend named Boolala that tells him to do bad things.")
...
scary2 = Film.create!(list: 'false', genre: 'scary', title: "The Girl With All The Gifts", year: 2016, rating: "R", description: "As fungus turns humanity into zombies, a band of survivors flees with a curiously evolved zombie girl who may hold the key to a cure.")
...
scary4 = Film.create!(list: 'true', genre: 'scary, indie', title: "Hush", year: 2016, rating: "R", description: "A deaf writer living alone in the woods must fight for her life in silence when a masked killer appears in her window.")
...
scary5 = Film.create!(list: 'false', genre: 'scary, indie', title: "The Inviation", year: 2015, rating: "TV-MA", description: "A get-together with his ex and her new husband may be the polite thing to do, but maybe not the most prudent.")
...
indie1 = Film.create!(list: 'true', genre: 'indie', title: "There Will Be Blood", year: 2007, rating: "R", description: "And ambitious prospector strikes it rich and turns a simple village into a boomtown, stoking the ire of a charismatic young preacher.")
...
# indie2 = Film.create!(genre: 'indie, scary', title: "The Endless", year: 2017, rating: "TV-MA", description: "Two adult brothers seek answers after an old video surfaces and brings them back to where they began... a UFO death cult.")
...
indie4 = Film.create!(list: 'false',  genre: 'indie', title: "Eighth Grade", year: 2018, rating: "R", description: "Despite her social isolation and fears about high school, a shy eighth grader musters up optimism to make it through the last week of middle school.")
...
# indie8 = Film.create!(genre: 'indie, comedy', title: "Silver Linings Playbook", year: 2012, rating: "R", description: "After a stint in a mental hospital, Pat moves in with his parents and tries to win back his wife, until he meets a woman who's as unstable as he is.")
...
# comedy1 = Film.create!(genre: 'comedy, indie', title: "The Disaster Artist", year: 2017, rating: "R", description: "Aspiring actor Greg moves to LA with his strange friend Tommy, then agrees to star in his movie. Things start weird and get a lot weirder.")
...
# comedy4 = Film.create!(genre: 'comedy, indie', title: "Safety Not Guaranteed", year: 2012, rating: "R", description: "A team of journalists are sent to find out who's behind a classified ad seeking a companion for time travel.")
...
comedy6 = Film.create!(list: 'true', genre: 'comedy', title: "Hot Fuzz", year: 2007, rating: "R", description: "A top London cop is assigned to investigate a seemingly sleepy town, which suddenly starts to stir with a series of grisly accidents.")
...
# comedy8 = Film.create!(genre: 'comedy, adventure', title: "The Hangover", year: 2009, rating: "R", description: "When three friends finally wake up after a wild bachelor party, they can't locate their best friend, who's supposed to be tying the knot.")
...
adventure3 = Film.create!(list: 'true', genre: 'adventure', title: "Mission Impossible 4: Ghost Protocol", year: 2011, rating: "PG-13", description: "Super-agent Ethan Hunt and his team take on another deadly mission... to prove their innocence when they are framed for bombing the Kremlin.")
