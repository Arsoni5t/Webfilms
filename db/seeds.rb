...
scary1 = Film.create!(genre: 'scary, indie', title: "Boolala", year: 2019, rating: "PG", description: "Zak has an invisible friend named Boolala that tells him to do bad things.")
...
scary4 = Film.create!(genre: 'scary, indie', title: "Hush", year: 2016, rating: "R", description: "A deaf writer living alone in the woods must fight for her life in silence when a masked killer appears in her window.")
...
scary5 = Film.create!(genre: 'scary, indie', title: "The Inviation", year: 2015, rating: "TV-MA", description: "A get-together with his ex and her new husband may be the polite thing to do, but maybe not the most prudent.")
